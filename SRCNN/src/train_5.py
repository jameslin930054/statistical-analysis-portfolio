import torch
import time
import srcnn_4 as srcnn
import torch.optim as optim
import torch.nn as nn
import os
import argparse
from tqdm import tqdm
from datasets_3 import get_datasets, get_dataloaders
from utils_0 import (
...
VALID_IMAGE_PATHS = '../input/test_bicubic_rgb_3x'
...
def train(model, dataloader):
    ...
    running_loss = 0.0
    running_psnr = 0.0
    for bi, data in tqdm(enumerate(dataloader), total=len(dataloader), leave=False): # 在這裡設置leave=False
